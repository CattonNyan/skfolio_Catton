...
class MonteCarloTests(unittest.TestCase):
    def test_simulate_monte_carlo_basic(self):
        ...
        self.assertIn("expected_max_drawdown_pct", res)
        self.assertIn("worst_max_drawdown_95pct", res)
        self.assertGreater(res["expected_max_drawdown_pct"], 0.0)
        self.assertGreater(res["worst_max_drawdown_95pct"], 0.0)
